...
const FeatureItem = ({ src, title, year, category, description }) => (
    <div className="flex md:flex-row flex-col md:space-x-10 items-center md:w-full">
        ...
        <div className="flex flex-col md:w-[417.46px] w-[300px]">
            <h1 className={`${heebo.className} md:text-[30px] text-[20px] text-black font-semibold mb-2 text-center md:text-start`}>{title}</h1>
            ...
            <p className={`${heebo.className} text-black md:text-[18px] text-[13px] leading-relaxed text-center md:text-start`}>{description}</p>
        </div>
    </div>
);
